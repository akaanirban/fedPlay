...
# -*- coding: utf-8 -*-
"""
Created on Jun 6/13/20 12:15 PM 2020
...
def SendModel(modelString):
    try:
        ...
        logging.error(msg=f"An error {e} occurred!")
        return 0
...
def GenerateData():
    ...
    try:
        ...
        for _ in range(10000):
            row = (np.random.sample(4) * np.random.uniform(5, 0.0001)) + np.random.uniform(-5,
                                                                                           5)  # Generate array of 4 numbers
